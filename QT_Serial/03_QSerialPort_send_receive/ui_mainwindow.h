...
public:
    ...
    QLineEdit *leSend;
    QPushButton *pbSend;
    QPlainTextEdit *pteDataFromSerial;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pteDataFromSerial = new QPlainTextEdit(centralwidget);
        pteDataFromSerial->setObjectName("pteDataFromSerial");

        gridLayout->addWidget(pteDataFromSerial, 1, 0, 1, 1);
